...
-- CreateIndex
CREATE UNIQUE INDEX "LibraryEntry_userId_itemId_key" ON "LibraryEntry"("userId", "itemId");
...
-- AddForeignKey
ALTER TABLE "LibraryEntry" ADD CONSTRAINT "LibraryEntry_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
